  ...
  return (
    <div className="font-sans pt-[96px] w-full bg-white flex px-[10%] lg:px-[100px] flex-col">
      ...
      <h2 className="font-mono font-thin text-xl md:text-3xl text-[#222] mt-2 md:w-6/12">
        I harness finance, technology,and user-centric design to elevate
        businesses
      </h2>
      <a
        href="#contact"
        className="mt-6 px-8 py-3 border-solid border-2 border-black rounded-lg text-[#000] text-xl self-start font-medium"
      >
        Let's Connect
      </a>
    </div>
